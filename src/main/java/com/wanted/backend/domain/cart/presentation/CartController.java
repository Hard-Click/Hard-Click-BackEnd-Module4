...
public class CartController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "장바구니 추가 성공"),
            @ApiResponse(responseCode = "401", description = "인증 실패"),
            @ApiResponse(responseCode = "404", description = "강의를 찾을 수 없음"),
            @ApiResponse(responseCode = "409", description = "이미 장바구니에 담긴 강의")
    })
    @PostMapping
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "장바구니 단건 삭제 성공"),
            @ApiResponse(responseCode = "401", description = "인증 실패"),
            @ApiResponse(responseCode = "404", description = "장바구니에 해당 강의가 없음")
    })
