...
class SaveWatchTimeServiceTest {
    ...
    void 진도_정보가_있으면_시청_시간을_누적한다() {
        ...
        service.handle(new SaveWatchTimeCommand(1L, 10L, 30));
        ...
        assertThat(captor.getValue().lastPositionSec()).isEqualTo(42);
    ...
    void 진도_정보가_없으면_새로_생성한다() {
        ...
        assertThat(captor.getValue().lastPositionSec()).isZero();
        assertThat(captor.getValue().watchTimeSec()).isEqualTo(30);
